...
while ulang == 'y' or 'Y':
    ...
    #Harga Awal
    nama = ['Duration SW20',"Castrol Magnatec","Federal Supreme XX","Yamalube","Shell"]
    ...
    for motor in nama:
        hrg = harga[a]
        print(str(nmr) + ". " + "{:19}".format(str(motor)) + " |  Rp." + format(hrg,',.2f'))
        nmr = nmr + 1
        a = a + 1
    print("======================================")
    ...
    while pilihan > 0 and pilihan < 6:
        ...
        print("Anda Akan Membeli Oli " + str(nama[idx]) + " Seharga Rp" + format(harga[idx],',.2f'))
        ...
        print("=============================================")
        print(">> Oli yang Anda Beli    : " + nama[idx])
